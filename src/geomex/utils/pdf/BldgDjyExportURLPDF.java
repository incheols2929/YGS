...
public class BldgDjyExportURLPDF {

    public BldgDjyExportURLPDF() {}

    public String CreateURLPDF(String key, String pnu, String user_name) throws Exception, DocumentException {

        //건축물대장 총괄 표제부
        String urlString = "http://127.0.0.1/intra/form/pdfprint/bldg/bldgdaejang.jsp?key="
            + key + "&pnu=" + pnu + "&user_name=" + user_name;

        URL url = new URL(urlString);
        HttpURLConnection con = (HttpURLConnection) url.openConnection();

        String pdfName = "건축물대장(총괄표제부)_" + Utils.getStrSec() + ".pdf";
