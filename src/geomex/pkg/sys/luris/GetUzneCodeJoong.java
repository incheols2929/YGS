 ...
 * 통합검색의 용도지역 중분류
 */
public class GetUzneCodeJoong implements Handler {
    ...
    public void perform(Map<String, String> kvp, HttpServletResponse res)
        ...
        String law_gbn = URLDecoder.decode(kvp.get("LAW_GBN"), "utf-8"); //한글처리

        ArrayList<ConditionSearch> cslist = Code.getUzneCodeJoong(law_gbn);
