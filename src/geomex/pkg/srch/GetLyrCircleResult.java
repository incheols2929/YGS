...
/**
 * 반경검색_레이어상세정보 결과목록을 가져온다.
 */
public class GetLyrCircleResult implements Handler {
    ...
    public void perform(Map<String, String> kvp, HttpServletResponse res)
        ...
        ArrayList<ConditionSearch> relist = CS.getSrchLryCircle(tbl_id, colkey, cx, cy, distance, srch_cond, lyr_nm); //결과목록을 가져온다.*/
