 ...
 * 통합검색의 용도지역 중분류
 */
public class GetUzneCodeSo implements Handler {
    ...
    public void perform(Map<String, String> kvp, HttpServletResponse res)
        ...
        String lyr_cd = URLDecoder.decode(kvp.get("LYR_ID"), "utf-8"); //한글처리

        ArrayList<ConditionSearch> cslist = Code.getUzneCodeSo(lyr_cd);
