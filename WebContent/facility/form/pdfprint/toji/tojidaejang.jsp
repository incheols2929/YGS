...
/* 토지대장 */
	...
	String JIMK_NM = vo2.getLandInfo().getJimkNm();
	String AREA = vo2.getLandInfo().getArea(); 
	...
	String MAP_NO_BONO = vo2.getLandInfo().getMapNoBono();
	String JIBUN = pnu.substring(11, 15) + "-" + pnu.substring(15, 19);
	String SCALE_NM = vo2.getLandInfo().getScaleNm();
