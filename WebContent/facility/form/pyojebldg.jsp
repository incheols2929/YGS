			...
			if($(xml).find("result").length != 0){
				...
				if(retult == "success"){
					if(confirm("건축물대장을 PDF로 다운로드 하시겠습니까?")) {
						printFrmClose();
						window.opener._PC.init.BldgpyodaeJangDownload(key_val, ouln_val, pnu, user_name);
						window.close();
			        } else {
			            return false;
			        }
...
<div style="height:17px; margin-top:5px;">
	<img src="../img/pp_img_1.gif" align="absmiddle"/> <b>건축물정보(<%= list.get(0).BLDG_TYPE %>)</b>
</div>
<div style="border-bottom:0px solid #e3e3e3; margin-top:4px;">
	<table border="0" cellpadding="0" cellspacing="0" width="100%" class="border1">
		<tr align="center">
			<td height="22" bgcolor="#eeeded" class="border2">대지위치</td>
			<td colspan="3" class="border2" align="left">&nbsp;<%=  list.get(0).ADDR %></td>
			<td bgcolor="#eeeded" class="border2">명칭 및 번호</td>
			<td class="border3" align="left">&nbsp;<%= list.get(0).BLD_NM %></td>
		</tr>
		<tr align="center">
			...
			<td bgcolor="#eeeded" class="border2">호수</td>
			<td  class="border3" align="left">&nbsp;<%= list.get(0).BL_NUM %></td>
		</tr>
		<tr align="center">
			...
			<td bgcolor="#eeeded" class="border2">층수</td>
			<td  class="border3" align="left">&nbsp;<%=  list.get(0).FLR%></td>
		</tr>
		<tr align="center">
			...
			<td bgcolor="#eeeded" class="border2">높이</td>
			<td  class="border3" align="left">&nbsp;<%= list.get(0).HEIGHT %></td>
		</tr>
		<tr align="center">
		...
		<tr align="center">
			<td height="22"  bgcolor="#eeeded" class="border2">주구조</td>
			<td class="border2" colspan="3" align="left">&nbsp;<%= list.get(0).BL_STRCT %></td>
			<td bgcolor="#eeeded" class="border2">지붕구조</td>
			<td  class="border3" colspan="2" align="left">&nbsp;<%= list.get(0).BL_ROOF%></td>
		</tr>
		<tr align="center">
			<td height="22"  bgcolor="#eeeded" class="border4">허가일자</td>
			<td class="border4" align="left">&nbsp; <%= list.get(0).PMT_YMD %></td>
			<td bgcolor="#eeeded" class="border4">착공일자</td>
			<td class="border4" align="left">&nbsp; <%= list.get(0).CON_YMD %></td>
			<td bgcolor="#eeeded" class="border4">사용승인일자</td>
			<td >&nbsp;<%= list.get(0).ACC_YMD %></td>
		</tr>
	</table>
</div>

<div style="height:17px; margin-top:5px;">
	<img src="../img/pp_img_3.gif" align="absmiddle" id="slide_page_img2"/> <b>층별현황</b>
</div>
<div style=" border-bottom:0px solid #e3e3e3; margin-top:4px;">
	<table border="0" cellpadding="0" cellspacing="0" width="100%" class="border1">
		<tr bgcolor="#eeeded" align="center">
			<td height="25" width="15%" class="border4">구분</td>
			<td height="25" width="15%" class="border4">층별</td>
			<td height="25" width="25%" class="border4">구조</td>
			<td height="25" width="15%" class="border4">용도</td>
			<td width="10%" bgcolor="#eeeded">면적(㎡)</td>
		</tr>
	</table>
</div>
<div id="slide_page_content2" style="height:80px; display:block; border-bottom:0px solid #e3e3e3; overflow: auto;">
	<table border="0" cellpadding="0" cellspacing="0" width="100%" class="table_border1">
		...
		<tr bgcolor="#f9f9f9" align="center">
			<td height="20" width="15%" class="<%=style3 %>"><%= list.get(i).FLR_TYPE %></td>
			<td height="20" width="15%" class="<%=style3 %>"><%= list.get(i).FLR_NM %></td>
			<td height="20" width="25%" class="<%=style3 %>"><%= list.get(i).FLR_STRCT %></td>
			<td height="20" width="15%" class="<%=style3 %>"><%= list.get(i).FLR_USABILITY %></td>
			<td width="10%" class="<%=style4 %>"><%= list.get(i).FLR_AREA %></td>
		</tr>
		<%
				}
			}else{
		%>
		  <tr bgcolor="#f9f9f9" align="center">
				<td height="60"  colspan="5">정보가 존재하지 않습니다.</td>
			</tr>
		<%
			}
		%>
...
<div style="height:17px; margin-top:5px;">
	<img src="../img/pp_img_1.gif" align="absmiddle"/> <b>승강기</b>
</div>
<div style=" border-bottom:0px solid #e3e3e3; margin-top:4px;">
	<table border="0" cellpadding="0" cellspacing="0" width="100%" class="border1">
		<tr align="center">
			<td height="20" bgcolor="#eeeded" width="20%" class="border4">승용</td>
			<td height="20" width="20%" align="left">&nbsp;<%= list.get(0).RIDING %></td>
			<td height="20" bgcolor="#eeeded" width="20%" class="border4">비상용</td>
			<td width="40%"  align="left">&nbsp;<%= list.get(0).RIDING_EMER %></td>
		</tr>
	</table>
</div>
...
<div style=" border-bottom:0px solid #e3e3e3; margin-top:4px;">
	<table border="0" cellpadding="0" cellspacing="0" width="100%" class="border1">
		<tr bgcolor="#eeeded" align="center">
			...
			<td class="border3" width="25%" >지능형전축물 인증</td>
		</tr>
		<tr  align="center">
...
<div id="print_form" style="display:none; position: absolute; top:50%; left:50%; margin:-100px 0 0 -160px; width:350px; height:250px; background-color:#ffffff;">
	<table border="0" cellpadding="0" cellspacing="0" width="100%" height="100%" class="table_border">
		...
		<input type="hidden" id="ouln_val" name="ouln_val" value="<%=list.get(0).BLDG_TYPE%>"/>
	</table>
</div>
