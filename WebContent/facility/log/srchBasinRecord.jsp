...
<body>
		...
		<tr>
			<td align="center" height="35">
				<table border="0" cellpadding="0" cellspacing="0" width="auto">
					<tr>
						<td width="90%" align="center" height="35"><b style="font-size: 25px;">저류지관리대장</b></td>
						<td width="10%">
			...
			<td>
				<table border="0" cellpadding="0" cellspacing="0" width="100%"
					...
					<tr>
						...
						<td colspan="4" width="15%"  align="center" class="line_border_2"><%=Code.getBasinFtrNm(ftridn)%></td>
						...
						<td width="10%" align="center"  class="line_border_2"><%=Code.getBasinMngNam(ftridn)%></td>
						<td width="10%" align="left" valign="top" class="line_border_1">&nbsp;관리자연락처</td>
						<td width="20%" align="center" 	class="line_border_right"><%=Code.getBasinMngNamTellNum(ftridn)%>
						</td>
					...
					<td colspan="6" width="10%" height="30" align="left" valign="top" class="line_border_1">&nbsp;소재지</td>
						<td  width="20%" align="center" 
							class="line_border_2"><%=Code.getBasinJuso(ftridn)%>
						</td>
						<td width="10%" align="left" valign="top" class="line_border_1">&nbsp;착공일자</td>
						<td width="20%" align="center" 
							class="line_border_2"><%=Code.getBasinBeg_YMD(ftridn)%>
						</td>
						<td width="10%" align="left" valign="top" class="line_border_1">&nbsp;준공일자</td>
						<td width="20%" align="center"
							class="line_border_right"><%=Code.getBasinFns_YMD(ftridn)%>
						</td>
						</tr>
				</table>
			</td>
	...
	<table border="0" cellpadding="0" cellspacing="0" width="100%"
		...
		<tr>
			...
			<td colspan="4" width="15%" align="center" class="line_border_2"><%=Code.getBasinRsv_Vol(ftridn) + " 천톤"%>
			</td>
			<td colspan="2" height="30" align="left" valign="top"
				class="line_border_1">&nbsp;단위저수량</td>
			<td width="15%" align="center" class="line_border_2"><%=Code.getBasinPdg_Unt(ftridn)%></td>
			<td colspan="2" height="30" align="left" valign="top"
				class="line_border_1">&nbsp;만수면적</td>
			<td width="15%" align="center" class="line_border_right"><%=Code.getBasinFul_Ara(ftridn) + " ha"%></td>
		</tr>
		<tr>
			...
			<td rowspan="2" colspan="4" width="15%" align="center"
				class="line_border_2"><%=Code.getBasinForm_Exp(ftridn)%>
			</td>
			<td rowspan="2" colspan="2" height="30" align="left" valign="top"
				class="line_border_1">&nbsp;제당연장</td>
			<td rowspan="2" align="center" class="line_border_2"><%=Code.getBasinByc_Len(ftridn)%></td>
			...
			<td align="center" class="line_border_right"><%=Code.getBasinTot_Jea(ftridn)%></td>
		</tr>
		<tr>
			<td height="20" align="left" valign="top" class="line_border_1">&nbsp;평고</td>
			<td align="center" class="line_border_right"><%=Code.getBasinAvg_Jea(ftridn)%>
			</td>
		</tr>
		<tr>
			<td rowspan="2" width="8%" height="30" align="left" valign="top"
			...
			<td rowspan="2" colspan="4" width="15%" align="center"
				class="line_border_2"><%=Code.getBasinWid_Len(ftridn)%>
			</td>
			<td rowspan="2" rowspan="4" height="30" align="center"
			...
			<td height="20" align="left" valign="top" class="line_border_1">&nbsp;내제</td>
			<td align="center" class="line_border_right"><%=Code.getBasinSlo_In_Sug(ftridn)%>
			</td>
		</tr>
		<tr>
			<td height="20" align="left" valign="top" class="line_border_1">&nbsp;외제</td>
			<td align="center" class="line_border_2"><%="(1:  " + Code.getBasinLat_Out_Su(ftridn) + ")"%>
			</td>
			<td height="20" align="left" valign="top" class="line_border_1">&nbsp;외제</td>
			<td align="center" class="line_border_right"><%=Code.getBasinSlo_Out_Su(ftridn)%>
			</td>
		</tr>
		...
		<tr>
			...
			<td colspan="4" width="15%" align="center" class="line_border_2"><%=Code.getBasinRsv_Ara(ftridn) + " 천톤"%></td>
			<td colspan="2" height="30" align="left" valign="top"
				class="line_border_1">&nbsp;홍수량</td>
			<td width="15%" align="center" class="line_border_2"><%=Code.getBasinDra_Wal(ftridn)%></td>
			<td colspan="2" height="30" align="left" valign="top"
				class="line_border_1">&nbsp;일류수심</td>
			<td width="15%" align="center" class="line_border_right"><%=Code.getBasinOrf_Dth(ftridn) + " ha"%></td>
		</tr>
		<tr>
		<tr>
			<td rowspan="2" width="8%" height="30" align="left" valign="top"
			...
			<td rowspan="2" colspan="4" width="15%" align="center"
				class="line_border_2"><%=Code.getBasinSct_Cmd(ftridn)%>
			</td>
			<td rowspan="2" colspan="2" height="30" align="left" valign="top"
				class="line_border_1">&nbsp;언체연장</td>
			<td rowspan="2" align="center" class="line_border_2"><%=Code.getBasinWsw_Len(ftridn)%>
			</td>
			<td rowspan="2" rowspan="4" height="30" align="center"
				class="line_border_2">&nbsp;언체고</td>
			<td height="20" align="left" valign="top" class="line_border_1">&nbsp;최고</td>
			<td align="center" class="line_border_right"><%=Code.getBasinMax_Un_Dra(ftridn)%>
			</td>
		</tr>
		<tr>
			<td height="20" align="left" valign="top" class="line_border_1">&nbsp;평균</td>
			<td align="center" class="line_border_right"><%=Code.getBasinAvg_Un_Dra(ftridn)%></td>
		</tr>
		...
		<tr>
			...
			<td rowspan="4" colspan="4" width="15%" align="center"
				class="line_border_2"><%=Code.getBasinRen_Dra(ftridn)%>
			</td>
			...
			<td align="center" class="line_border_2"><%=Code.getBasinMax_Dra(ftridn)%>
			</td>
			<td rowspan="4" colspan="2" height="30" align="left" valign="top"
				class="line_border_1">&nbsp;홍수위 상제고</td>
			<td rowspan="4" align="center" class="line_border_right"><%=Code.getBasinWtr_Dra(ftridn)%>
			</td>
		</tr>
		<tr>
		<tr>
			<td height="20" align="left" valign="top" class="line_border_1">&nbsp;최소</td>
			<td align="center" class="line_border_2"><%=Code.getBasinMin_Dra(ftridn)%>
			</td>
		<tr>
			<td height="20" align="left" valign="top" class="line_border_1">&nbsp;평균</td>
			<td align="center" class="line_border_2"><%=Code.getBasinAvg_Dra(ftridn)%>
			</td>
		</tr>
		...
		<tr>
			<!-- 통관및 취수시설 -->
		<tr>
			<td rowspan="6" height="30" align="center" class="line_border_2">통관 및 취수시설</td>

			<td rowspan="4" width="8%" height="30" align="left" valign="top"
				class="line_border_1">&nbsp;통관형식</td>
			<td rowspan="4" colspan="4" width="15%" align="center"
				class="line_border_2"><%=Code.getBasinCde_Wtl(ftridn)%>
			</td>
			<td rowspan="4" height="30" align="center" class="line_border_2">&nbsp;통관연장</td>
			<td rowspan="4" colspan="2" align="center" class="line_border_2"><%=Code.getBasinRen_Wtl(ftridn)%>
			</td>
			...
			<td align="center" class="line_border_2"><%=Code.getBasinSec_P_Wtl(ftridn) + "mm"%>
			</td>
		</tr>
		<tr>
		<tr>
			<td height="20" align="left" valign="top" class="line_border_right">&nbsp;H:</td>
			<td align="center" class="line_border_2"><%=Code.getBasinSec_H_Wtl(ftridn)%>
			</td>
		<tr>
		...
		<tr>
			...
			<td rowspan="2" colspan="4" width="15%" align="center"
				class="line_border_2"><%=Code.getBasinStr_Wtl(ftridn)%>
			</td>
			<td rowspan="2" rowspan="4" height="30" align="center"
				class="line_border_2">&nbsp;취수공</td>
			<td height="20" align="left" valign="top" class="line_border_1">&nbsp;개소:</td>
			<td align="center" class="line_border_2"><%="(1:  " + Code.getBasinSec_Wtl(ftridn) + ")"%>
			</td>
			<td rowspan="2" width="8%" height="30" align="left" valign="top"
				class="line_border_1">&nbsp;취수능력</td>
			<td rowspan="2" colspan="4" width="15%" align="center"
				class="line_border_right"><%=Code.getBasinInt_Wtl(ftridn) + " ㎡/sec"%>
			</td>
		</tr>
		<tr>
			<td height="20" align="left" valign="top" class="line_border_1">&nbsp;규격:</td>
			<td align="center" class="line_border_2"><%="(1:  " + Code.getBasinStd_Wtl(ftridn) + ")"%>
			</td>
		...
		<tr>
			...
			<td width="15%" align="center" class="line_border_2"><%=Code.getBasinMai_Way(ftridn)%></td>
			<td colspan="2" height="32" align="left" valign="top"
				class="line_border_1">&nbsp;용수지선</td>
			<td width="15%" align="center" class="line_border_2"><%=Code.getBasinBra_Way(ftridn)%></td>
			<td colspan="2" height="32" align="left" valign="top"
				class="line_border_1">&nbsp;추&nbsp;&nbsp;도</td>
			<td width="15%" align="center" class="line_border_right"><%=Code.getBasinChu_Way(ftridn)%></td>
		</tr>
		<tr>
			<td colspan="4" width="8%" height="32" align="left" valign="top"
				class="line_border_1">&nbsp;도 수 로</td>
			<td width="15%" align="center" class="line_border_2"><%=Code.getBasinRac_Way(ftridn)%></td>
			<td colspan="2" height="32" align="left" valign="top"
				class="line_border_1">&nbsp;송 수 로</td>
			<td width="15%" align="center" class="line_border_2"><%=Code.getBasinAqu_Way(ftridn)%></td>
			<td colspan="2" height="32" align="left" valign="top"
				class="line_border_1">&nbsp;배 수 로</td>
			<td width="15%" align="center" class="line_border_right"><%=Code.getBasinDrain_Way(ftridn)%></td>
		</tr>


		<!-- 관개면적 -->
		<tr>
			<td width="20%" height="30" align="center" class="line_border_2">&nbsp;관개면적
			</td>
			<td colspan="4" width="8%" height="20" align="left" valign="top"
				class="line_border_1">&nbsp;인가</td>
			<td width="15%" align="center" class="line_border_2"><%=Code.getBasinStr_Ara(ftridn)%></td>
			<td colspan="2" height="20" align="left" valign="top"
				class="line_border_1">&nbsp;내한면적</td>
			<td width="15%" align="center" class="line_border_2"><%=Code.getBasinVis_Ara(ftridn)%></td>
			<td colspan="2" height="20" align="left" valign="top"
				class="line_border_1">&nbsp;부족면적</td>
			<td width="15%" align="center" class="line_border_right"><%=Code.getBasinTri_Ara(ftridn)%></td>
...
<!-- <table border="0" cellpadding="0" cellspacing="0" width="1150"
	...
	<table border="0" cellpadding="0" cellspacing="0" width="100%">
			...
			<%
						...
						<img alt="error" src="/ygsimg/<%=Img_list.get(i).FILE_PATH%>" height="600px" width="480px" align="center"></td>
						<td  class="line_border_5" width="10">&nbsp;</td>
						<%
							}
							}else{
...
<div class="page_layout">
	...
	<table border="0" cellpadding="0" cellspacing="0" width="100%" class="line_border">
		<tr>
			...
			<td align="center" class="line_border_2"><%=Code.getSrchBasinNAT_AMT(ftridn)%></td>
			<td width="11.5%" colspan="2" height="40" align="left" valign="top"class="line_border_1">&nbsp;지방비</td>
			<td align="center" class="line_border_2"><%=Code.getSrchBasinCIT_AMT(ftridn)%></td>
			<td width="15%" colspan="2" height="40" align="left" valign="top"class="line_border_1">&nbsp;융자</td>
			<td align="center" class="line_border_right"><%=Code.getSrchBasinBND_AMT(ftridn)%></td>
		</tr>
		
		<tr>
			<td colspan="2" width="9%" height="40" align="left" valign="top"class="line_border_1">&nbsp;자부담등</td>
			<td width="15%" align="center" class="line_border_2"><%=Code.getSrchBasinSEL_AMT(ftridn)%></td>
			<td colspan="2" height="40" align="left" valign="top"class="line_border_1">&nbsp;계</td>
			<td width="15%" align="center" class="line_border_2"><%=Code.getSrchBasinALL_AMT(ftridn)%></td> 
		...
		<tr>
			...
			<td align="center" class="line_border_2">&nbsp;<%=Code.getSrchBasinDPC_AMT(ftridn) %></td>
			<td  width="11.5%" colspan="2" height="40" align="left" valign="top"class="line_border_1">&nbsp;자재비</td>
			<td align="center" class="line_border_2">&nbsp;<%=Code.getSrchBasinDGV_AMT(ftridn) %></td>
			<td width="15%" colspan="2" height="40" align="left" valign="top"class="line_border_1">&nbsp;용지매수비</td>
			<td align="center" class="line_border_right"><%=Code.getSrchBasinLAND_AMT(ftridn) %></td> 
			
		</tr>
		<tr>
			<td colspan="2" width="9%" height="40" align="left" valign="top"class="line_border_1">&nbsp;설계공감비</td>
			<td width="15%" align="center" class="line_border_2"><%=Code.getSrchBasinDSN_AMT(ftridn) %></td>
			<td colspan="2" height="40" align="left" valign="top"class="line_border_1">&nbsp;관리비 기타</td>
			<td width="15%" align="center" class="line_border_2"><%=Code.getSrchBasinDET_AMT(ftridn) %></td>
			<td colspan="2" height="40" align="left" valign="top"class="line_border_1">&nbsp;계</td>
			<td width="15%" align="center" class="line_border_right"><%=Code.getSrchBasinTCO_AMT(ftridn) %></td>
		</tr>
	</table>
