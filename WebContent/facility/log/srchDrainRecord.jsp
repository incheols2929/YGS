...
<%
	...
	String mngcde = Code.getDrainMNGPositionPrint(ftridn);
...
<body>
				...
				<table border="0" cellpadding="0" cellspacing="0" width="auto">
					<tr>
						<td width="90%" align="center" height="35"><b
							style="font-size: 25px;">배수장관리대장</b></td>
		...
		<tr>
			<td>
				<table border="0" cellpadding="0" cellspacing="0" width="100%"
					class="line_border">
					<tr>
						<td width="6%" height="30" align="left" valign="top" class="line_border_1">&nbsp;시설명</td>
						<td colspan="4" width="15%" align="center" class="line_border_2"><%=Code.getSrchDrainFTR_NM(ftridn) + "배수장"%></td>
						<td width="10%" align="left" valign="top" class="line_border_1">&nbsp;소재지</td>
						<td width="30%" align="left" valign="bottom" class="line_border_2"><%=Code.getSrchDrainJUSO(ftridn)%></td>
						<td width="10%" align="left" valign="top" class="line_border_1">&nbsp;관리자</td>
						<td width="10%" align="center" valign="bottom"
							class="line_border_2"><%=Code.getSrchDrainMNG_NAM(ftridn)%>
						</td>
						<td width="10%" align="left" valign="top" class="line_border_1">&nbsp;관리자연락처</td>
						<td width="20%" align="center" valign="bottom"
							class="line_border_right"><%=Code.getSrchDrainTEL_NUM(ftridn)%>
						</td>
					</tr>
						<tr>
					<td width="6%" height="30" align="left" valign="top"
							class="line_border_1">&nbsp;착공일자</td>
						<td colspan="4" width="15%" align="center" class="line_border_2"><%=Code.getSrchDrainBEG_YMD(ftridn)%></td>
						<td width="10%" align="left" valign="top" class="line_border_1">&nbsp;준공일자</td>
						<td width="30%" align="left" valign="bottom" class="line_border_2"><%=Code.getSrchDrainFNS_YMD(ftridn)%></td>
						<td width="10%" align="left" valign="top" class="line_border_1">&nbsp;수계명</td>
						<td width="10%" align="center" valign="bottom"
							class="line_border_2"><%=Code.getSrchDrainWSS_NM(ftridn)%>
						</td>
						<td width="10%" align="left" valign="top" class="line_border_1">&nbsp;유역면적(ha)</td>
						<td width="20%" align="center" valign="bottom"
							class="line_border_right"><%=Code.getSrchDrainRSV_AREA(ftridn)%>
						</td>
				</table>
			</td>
		</tr>
	...
	<table border="0" cellpadding="0" cellspacing="0" width="100%"
		class="line_border">
		<tr>
			<td rowspan="1" width="20%" height="40" align="center"
				class="line_border_2">&nbsp;양수장 관계면적</td>
			<td width="9%" height="40" align="left" valign="top"
				class="line_border_1">&nbsp;신규(ha)</td>
			<td colspan="2" width="10%" align="center" class="line_border_2"><%=Code.getSrchDrainIRR_NEW(ftridn) + " ha"%>
			</td>
			<td colspan="2" height="40" align="left" valign="top"width="9%"
				class="line_border_1">&nbsp;보강(ha)</td>
			<td width="10%" align="center" class="line_border_2"><%=Code.getSrchDrainIRR_FIX(ftridn) + "ha"%></td>
			<td colspan="2" height="40" align="left" valign="top" width="9%"
				class="line_border_1">&nbsp;향후개발(ha)</td>
			<td width="10%" align="center" class="line_border_2"><%=Code.getSrchDrainIRR_DEV(ftridn) + " ha"%></td>
			<td  height="40" align="left" valign="top"
				class="line_border_1">&nbsp;구역외(ha)</td>
			<td width="10%" align="center" class="line_border_right"><%=Code.getSrchDrainIRR_ETC(ftridn) + " ha"%></td>
		</tr>
		<tr>
			<td rowspan="5" width="20%" height="40" align="center"
				class="line_border_2">&nbsp;양수장 제원</td>
			<td width="9%" height="40" align="left" valign="top"
				class="line_border_1">&nbsp;홍수량(㎡/sec)</td>
			<td colspan="4" width="10%" align="center" class="line_border_2"><%=Code.getSrchDrainDRA_WAL(ftridn) + " ㎡/sec"%>
			</td>
			<td colspan="2" height="40" align="left" valign="top"width="9%"
				class="line_border_1">&nbsp;갈수량(㎡/sec)</td>
			<td width="10%" align="center" class="line_border_2"><%=Code.getSrchDrainTHR_WAL(ftridn) + "㎡/sec"%></td>
			<td colspan="2" height="40" align="left" valign="top" width="9%"
				class="line_border_1">&nbsp;배수량(㎡/sec)</td>
			<td width="10%" align="center" class="line_border_right"><%=Code.getSrchDrainDRAIN_WAL(ftridn) + " ㎡/sec"%></td>
			
		</tr>
		<tr>
			<td width="9%" height="40" align="left" valign="top"
				class="line_border_1">&nbsp;실양정(m)</td>
			<td colspan="4" width="10%" align="center" class="line_border_2"><%=Code.getSrchDrainAVT_HEAD(ftridn) + " m"%>
			</td>
			<td colspan="2" height="40" align="left" valign="top"width="9%"
				class="line_border_1">&nbsp;전양정(m)</td>
			<td width="10%" align="center" class="line_border_2"><%=Code.getSrchDrainDEV_HEAD(ftridn) + "m"%></td>
			<td colspan="2" height="40" align="left" valign="top" width="9%"
				class="line_border_1">&nbsp;엔진(HP대)</td>
			<td width="10%" align="center" class="line_border_right"><%=Code.getSrchDrainENG_HP(ftridn) %></td>
			
		</tr>
		
		<tr>
			<td width="9%" height="40" align="left" valign="top"
				class="line_border_1">&nbsp;토출관(㎜대)</td>
			<td colspan="4" width="10%" align="center" class="line_border_2"><%=Code.getSrchDrainPUMP_MM(ftridn)%>
			</td>
			<td colspan="2" height="40" align="left" valign="top"width="9%"
				class="line_border_1">&nbsp;변압기(KVA대)</td>
			<td width="10%" align="center" class="line_border_2"><%=Code.getSrchDrainTRANS_VOL(ftridn) %></td>
			<td colspan="2" height="40" align="left" valign="top" width="9%"
				class="line_border_1">&nbsp;배전선로(m)</td>
			<td width="10%" align="center" class="line_border_right"><%=Code.getSrchDrainDIST_LINE(ftridn) + " m"%></td>
			
		</tr>
		
		<tr>
			<td width="9%" height="40" align="left" valign="top"
				class="line_border_1">&nbsp;기중장비(T/대)</td>
			<td colspan="4" width="10%" align="center" class="line_border_2"><%=Code.getSrchDrainCRAN_EQUI(ftridn)%>
			</td>
			<td colspan="2" height="40" align="left" valign="top"width="9%"
				class="line_border_1">&nbsp;도수로(조/m)</td>
			<td width="10%" align="center" class="line_border_2"><%=Code.getSrchDrainRAC_WAY(ftridn) %></td>
			<td colspan="2" height="40" align="left" valign="top" width="9%"
				class="line_border_1">&nbsp;송수로(조/m)</td>
			<td width="10%" align="center" class="line_border_right"><%=Code.getSrchDrainAQU_WAY(ftridn) + " m"%></td>
			
		</tr>
		
			<tr>
			<td width="9%" height="40" align="left" valign="top"
				class="line_border_1">&nbsp;용수로(조/m)</td>
			<td colspan="4" width="10%" align="center" class="line_border_2"><%=Code.getSrchDrainIRR_WAY(ftridn)%>
			</td>
			<td colspan="2" height="40" align="left" valign="top"width="9%"
				class="line_border_1">&nbsp;배수로(조/m)</td>
			<td width="10%" align="center" class="line_border_2"><%=Code.getSrchDrainDRAIN_WAY(ftridn) %></td>
			<td colspan="2" height="40" align="left" valign="top" width="9%"
				class="line_border_1">&nbsp;터널(조/m)</td>
			<td width="10%" align="center" class="line_border_right"><%=Code.getSrchDrainTRN_LEN(ftridn) + " m"%></td>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%" class="line_border">
		<tr>
			...
			<td colspan="4" width="10%" align="center" class="line_border_2"><%=Code.getSrchDrainNAT_AMT(ftridn)%></td>
			<td colspan="2" height="40" align="left" valign="top"width="9%"	class="line_border_1">&nbsp;지방비</td>
			<td width="10%" align="center" class="line_border_2"><%=Code.getSrchDrainCIT_AMT(ftridn)%></td>
			<td colspan="2" height="40" align="left" valign="top" width="9%"class="line_border_1">&nbsp;융자</td>
			<td width="10%" align="center" class="line_border_right"><%=Code.getSrchDrainBND_AMT(ftridn)%></td>
		</tr>
		<tr>
				<td width="9%" height="40" align="left" valign="top"
				class="line_border_1">&nbsp;자부담등</td>
			<td colspan="4" width="10%" align="center" class="line_border_2"><%=Code.getSrchDrainSEL_AMT(ftridn)%>
			</td>
			<td colspan="2" height="40" align="left" valign="top"width="9%"
				class="line_border_1">&nbsp;계</td>
			<td width="10%" align="center" class="line_border_2"><%=Code.getSrchDrainALL_AMT(ftridn)%></td>
			<td colspan="2" height="40" align="left" valign="top" width="9%"
				class="line_border_1">&nbsp;</td>
			<td width="10%" align="center" class="line_border_right">&nbsp;</td>
		</tr>
		<tr>
			<td rowspan="2" width="20%" height="40" align="center"
				class="line_border_2">&nbsp;설치비 지출내역</td>
			<td width="9%" height="40" align="left" valign="top"
				class="line_border_1">&nbsp;순공사비</td>
			<td colspan="4" width="10%" align="center" class="line_border_2"><%=Code.getSrchDrainDPC_AMT(ftridn)%>
			</td>
			<td colspan="2" height="40" align="left" valign="top"width="9%"
				class="line_border_1">&nbsp;자재비</td>
			<td width="10%" align="center" class="line_border_2"><%=Code.getSrchDrainDGV_AMT(ftridn)%></td>
			<td colspan="2" height="40" align="left" valign="top" width="9%"
				class="line_border_1">&nbsp;용지매수비</td>
			<td width="10%" align="center" class="line_border_right"><%=Code.getSrchDrainLAND_AMT(ftridn)%></td>
			
		</tr>
	<tr>
			
			<td width="9%" height="40" align="left" valign="top"
				class="line_border_1">&nbsp;설계공감비</td>
			<td colspan="4" width="10%" align="center" class="line_border_2"><%=Code.getSrchDrainDSN_AMT(ftridn)%>
			</td>
			<td colspan="2" height="40" align="left" valign="top"width="9%"
				class="line_border_1">&nbsp;관리비 기타</td>
			<td width="10%" align="center" class="line_border_2"><%=Code.getSrchDrainDET_AMT(ftridn)%></td>
			<td colspan="2" height="40" align="left" valign="top" width="9%"
				class="line_border_1">&nbsp;계</td>
			<td width="10%" align="center" class="line_border_right"><%=Code.getSrchDrainTCO_AMT(ftridn)%></td>
...
<!-- <table border="0" cellpadding="0" cellspacing="0" width="1150"
	...
	<table border="0" cellpadding="0" cellspacing="0" width="100%">
			 ...
			 <%
						...
						%>
						<td class="line_border_5" width="480px" align="center" height="600px">이미지가 없습니다</td>
						<td class="line_border_5" width="480px" align="center" height="600px">이미지가 없습니다</td>
						<%
							}
						%>
