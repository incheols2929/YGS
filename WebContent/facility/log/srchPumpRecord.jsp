...
<%
	...
	String mngcde = Code.getPumpMNGPositionPrint(ftridn);
...
<body>
				...
				<table border="0" cellpadding="0" cellspacing="0" width="auto">
					<tr>
						<td width="90%" align="center" height="35"><b
							style="font-size: 25px;">양수장관리대장</b></td>
			...
			<td>
				<table border="0" cellpadding="0" cellspacing="0" width="100%"
					...
					<tr>
						...
						<td colspan="4" width="15%" align="center" class="line_border_2"><%=Code.getSrchPumpFTR_NM(ftridn)%></td>
						<td width="10%" align="left" valign="top" class="line_border_1">&nbsp;소재지</td>
						<td width="30%" align="left" valign="bottom" class="line_border_2"><%=Code.getSrchPumpJUSO(ftridn)%></td>
						<td width="10%" align="left" valign="top" class="line_border_1">&nbsp;관리자</td>
						<td width="10%" align="center" valign="bottom" class="line_border_2"><%=Code.getSrchPumpMNG_NAM(ftridn)%></td>
						<td width="10%" align="left" valign="top" class="line_border_1">&nbsp;관리자연락처</td>
						<td width="20%" align="center" valign="bottom"	class="line_border_right"><%=Code.getSrchPumpTEL_NUM(ftridn)%></td>
					</tr>
					<tr>
						<td width="6%" height="30" align="left" valign="top" class="line_border_1">&nbsp;착공일자</td>
						<td colspan="4" width="15%" align="center" class="line_border_2"><%=Code.getSrchPumpBEG_YMD(ftridn)%></td>
						<td width="10%" align="left" valign="top" class="line_border_1">&nbsp;준공일자</td>
						<td width="30%" align="left" valign="bottom" class="line_border_2"><%=Code.getSrchPumpFNS_YMD(ftridn)%></td>
						<td width="10%" align="left" valign="top" class="line_border_1">&nbsp;수계명</td>
						<td width="10%" align="center" valign="bottom"	class="line_border_2"><%=Code.getSrchPumpWSS_NM(ftridn)%></td>
						<td width="10%" align="left" valign="top" class="line_border_1">&nbsp;유역면적(ha)</td>
						<td width="20%" align="center" valign="bottom" class="line_border_right"><%=Code.getSrchPumpRSV_AREA(ftridn)%></td>
					</tr>
				</table>
			</td>
		</tr>
	</table>
	<table border="0" cellpadding="0" cellspacing="0" width="100%" class="line_border5">
		<tr>
	...
	<table border="0" cellpadding="0" cellspacing="0" width="100%"
		class="line_border">
		<tr>
			<td rowspan="1" width="20%" height="40" align="center" class="line_border_2">&nbsp;양수장 관계면적</td>
			<td width="9%" height="40" align="left" valign="top" class="line_border_1">&nbsp;신규(ha)</td>
			<td colspan="2" width="10%" align="center" class="line_border_2"><%=Code.getSrchPumpIRR_NEW(ftridn) + " ha"%></td>
			<td colspan="2" height="40" align="left" valign="top"width="9%"	class="line_border_1">&nbsp;보강(ha)</td>
			<td width="10%" align="center" class="line_border_2"><%=Code.getSrchPumpIRR_FIX(ftridn) + "ha"%></td>
			<td colspan="2" height="40" align="left" valign="top" width="9%" class="line_border_1">&nbsp;향후개발(ha)</td>
			<td width="10%" align="center" class="line_border_2"><%=Code.getSrchPumpIRR_DEV(ftridn) + " ha"%></td>
			<td  height="40" align="left" valign="top" class="line_border_1">&nbsp;구역외(ha)</td>
			<td width="10%" align="center" class="line_border_right"><%=Code.getSrchPumpIRR_ETC(ftridn) + " ha"%></td>
		</tr>
		<tr>
			<td rowspan="5" width="20%" height="40" align="center" class="line_border_2">&nbsp;양수장 제원</td>
			<td width="9%" height="40" align="left" valign="top" class="line_border_1">&nbsp;홍수량(㎡/sec)</td>
			<td colspan="4" width="10%" align="center" class="line_border_2"><%=Code.getSrchPumpDRA_WAL(ftridn) + " ㎡/sec"%></td>
			<td colspan="2" height="40" align="left" valign="top"width="9%"	class="line_border_1">&nbsp;갈수량(㎡/sec)</td>
			<td width="10%" align="center" class="line_border_2"><%=Code.getSrchPumpTHR_WAL(ftridn) + "㎡/sec"%></td>
			<td colspan="2" height="40" align="left" valign="top" width="9%" class="line_border_1">&nbsp;양수량(㎡/mm)</td>
			<td width="10%" align="center" class="line_border_right"><%=Code.getSrchPumpPUMP_WAL(ftridn) + " ㎡/mm"%></td>
			
		</tr>
		<tr>
			<td width="9%" height="40" align="left" valign="top" class="line_border_1">&nbsp;실양정(m)</td>
			<td colspan="4" width="10%" align="center" class="line_border_2"><%=Code.getSrchPumpAVT_HEAD(ftridn) + " m"%></td>
			<td colspan="2" height="40" align="left" valign="top"width="9%"	class="line_border_1">&nbsp;전양정(m)</td>
			<td width="10%" align="center" class="line_border_2"><%=Code.getSrchPumpDEV_HEAD(ftridn) + "m"%></td>
			<td colspan="2" height="40" align="left" valign="top" width="9%" class="line_border_1">&nbsp;엔진(HP대)</td>
			<td width="10%" align="center" class="line_border_right"><%=Code.getSrchPumpENG_HP(ftridn) %></td>
			
		</tr>
		
		<tr>
			<td width="9%" height="40" align="left" valign="top" class="line_border_1">&nbsp;펌프(㎜대)</td>
			<td colspan="4" width="10%" align="center" class="line_border_2"><%=Code.getSrchPumpPUMP_MM(ftridn)%></td>
			<td colspan="2" height="40" align="left" valign="top"width="9%" class="line_border_1">&nbsp;변압기(KVA대)</td>
			<td width="10%" align="center" class="line_border_2"><%=Code.getSrchPumpTRANS_VOL(ftridn) %></td>
			<td colspan="2" height="40" align="left" valign="top" width="9%" class="line_border_1">&nbsp;배전선로(m)</td>
			<td width="10%" align="center" class="line_border_right"><%=Code.getSrchPumpDIST_LINE(ftridn) + " m"%></td>
			
		</tr>
		
		<tr>
			<td width="9%" height="40" align="left" valign="top" class="line_border_1">&nbsp;기중장비(T/대)</td>
			<td colspan="4" width="10%" align="center" class="line_border_2"><%=Code.getSrchPumpCRAN_EQUI(ftridn)%></td>
			<td colspan="2" height="40" align="left" valign="top"width="9%"	class="line_border_1">&nbsp;도수로(조/m)</td>
			<td width="10%" align="center" class="line_border_2"><%=Code.getSrchPumpRAC_WAY(ftridn) %></td>
			<td colspan="2" height="40" align="left" valign="top" width="9%"class="line_border_1">&nbsp;송수로(조/m)</td>
			<td width="10%" align="center" class="line_border_right"><%=Code.getSrchPumpAQU_WAY(ftridn) + " m"%></td>
			
		</tr>
		
			<tr>
			<td width="9%" height="40" align="left" valign="top"class="line_border_1">&nbsp;용수로(조/m)</td>
			<td colspan="4" width="10%" align="center" class="line_border_2"><%=Code.getSrchPumpIRR_WAY(ftridn)%></td>
			<td colspan="2" height="40" align="left" valign="top"width="9%"	class="line_border_1">&nbsp;배수로(조/m)</td>
			<td width="10%" align="center" class="line_border_2"><%=Code.getSrchPumpDRAIN_WAY(ftridn) %></td>
			<td colspan="2" height="40" align="left" valign="top" width="9%"class="line_border_1">&nbsp;터널(조/m)</td>
			<td width="10%" align="center" class="line_border_right"><%=Code.getSrchPumpTRN_LEN(ftridn) + " m"%></td>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%"	class="line_border">
		<tr>
			<td rowspan="2" width="20%" height="40" align="center"	class="line_border_2">&nbsp;설치비 제원별</td>
			<td width="9%" height="40" align="left" valign="top"	class="line_border_1">&nbsp;국비보조</td>
			<td colspan="4" width="10%" align="center" class="line_border_2"><%=Code.getSrchPumpNAT_AMT(ftridn)%></td>
			<td colspan="2" height="40" align="left" valign="top"width="9%"	class="line_border_1">&nbsp;지방비</td>
			<td width="10%" align="center" class="line_border_2"><%=Code.getSrchPumpCIT_AMT(ftridn)%></td>
			<td colspan="2" height="40" align="left" valign="top" width="9%" class="line_border_1">&nbsp;융자</td>
			<td width="10%" align="center" class="line_border_right"><%=Code.getSrchPumpBND_AMT(ftridn)%></td>
		</tr>
		<tr>
			<td width="9%" height="40" align="left" valign="top" class="line_border_1">&nbsp;자부담등</td>
			<td colspan="4" width="10%" align="center" class="line_border_2"><%=Code.getSrchPumpSEL_AMT(ftridn)%></td>
			<td colspan="2" height="40" align="left" valign="top"width="9%"	class="line_border_1">&nbsp;계</td>
			<td width="10%" align="center" class="line_border_2"><%=Code.getSrchPumpALL_AMT(ftridn)%></td>
		...
		<tr>
			<td rowspan="2" width="20%" height="40" align="center"	class="line_border_2">&nbsp;설치비 지출내역</td>
			<td width="9%" height="40" align="left" valign="top"	class="line_border_1">&nbsp;순공사비</td>
			<td colspan="4" width="10%" align="center" class="line_border_2"><%=Code.getSrchPumpDPC_AMT(ftridn)%></td>
			<td colspan="2" height="40" align="left" valign="top"width="9%"	class="line_border_1">&nbsp;자재비</td>
			<td width="10%" align="center" class="line_border_2"><%=Code.getSrchPumpDGV_AMT(ftridn)%></td>
			<td colspan="2" height="40" align="left" valign="top" width="9%"	class="line_border_1">&nbsp;용지매수비</td>
			<td width="10%" align="center" class="line_border_right"><%=Code.getSrchPumpLAND_AMT(ftridn)%></td>
			
		</tr>
		<tr>
			
			<td width="9%" height="40" align="left" valign="top" class="line_border_1">&nbsp;설계공감비</td>
			<td colspan="4" width="10%" align="center" class="line_border_2"><%=Code.getSrchPumpDSN_AMT(ftridn)%></td>
			<td colspan="2" height="40" align="left" valign="top"width="9%"	class="line_border_1">&nbsp;관리비 기타</td>
			<td width="10%" align="center" class="line_border_2"><%=Code.getSrchPumpDET_AMT(ftridn)%></td>
			<td colspan="2" height="40" align="left" valign="top" width="9%" class="line_border_1">&nbsp;계</td>
			<td width="10%" align="center" class="line_border_right"><%=Code.getSrchPumpTCO_AMT(ftridn)%></td>
		</tr>
				...
				<%-- <table border="0" cellpadding="0" cellspacing="0" width="auto">
					<tr>
						...
						<td class="line_border_5" width="530px" align="center" height="430px"><img
							...
							height="430px" width="530px" align="center"></td>
	...
	<!-- 필지정보 -->
		...
		<tr>
			<%
				if (F_list.size() != 0) {
			%>
			<td rowspan="<%=F_list.size() + 1%>" width="23.5%" height="30"
				align="center" class="line_border_2">&nbsp;필지정보</td>
			<%
				} else {
			%>
			<td rowspan="2" width="23.5%" height="30" align="center"
...
<%-- 			<%
		...
		%>
<!-- 		<tr>
			<td width="13%" height="30" align="center" class="line_border_2"></td><td width="13%" height="30" align="center" class="line_border_2"></td><td width="13%" height="30" align="center" class="line_border_2"></td><td width="13%" height="30" align="center" class="line_border_2"></td><td width="13%" height="30" align="center" class="line_border_right"></td>
		</tr>		
		<tr>
			<td width="13%" height="30" align="center" class="line_border_2"></td><td width="13%" height="30" align="center" class="line_border_2"></td><td width="13%" height="30" align="center" class="line_border_2"></td><td width="13%" height="30" align="center" class="line_border_2"></td><td width="13%" height="30" align="center" class="line_border_right"></td>
		</tr>		
