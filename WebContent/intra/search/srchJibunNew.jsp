...
<div id="jibun_sch_box" style="width:100%; height:131px; border:0px solid #000000; padding-top:30px;">
	<div style="height:22px; border:0px solid #000000; margin-top:5px;">
		<ul>
			<li style="float: left; width:60px; list-sstyle: none;"><p style="padding:5px"><img src="img/p.gif" align="absmiddle"> 시군</p></li>
	...
	<div style="height:22px; border:0px solid #000000;">
		<ul>
