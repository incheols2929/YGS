...
<%
	...
	String authCheckB = Code.getAuthCheckB(session_bizid, id, session_ugrp_id); ////사용자 권한체크
%>
<html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1" />
<title>:: 영광군 행정지원 공간정보시스템 ::</title>
...
<!-- 개발용 -->
<SCRIPT type="text/javascript" src="http://openapi.map.naver.com/js/naverMap.naver?key=cf82b3fd61eafa0cb2ef28800e3749b6"></SCRIPT>
<SCRIPT language="JavaScript" type="text/javascript" src="http://map.vworld.kr/js/sopMapInit.js.do?apiKey=C40B51FA-41EC-3B52-8800-994B4C47C29B"></SCRIPT>
<script type="text/javascript" src="//apis.daum.net/maps/maps3.js?apikey=6f3ebf167e3e4e0f9b1129e8c88fa203"></script>
		...
		<div id="gw_top_bg">
			<div id="gw_top">
				...
				<div id="gw_logo_box" align="center">
					<img id="logo" src="./img/back/logo.png" style="margin:0 0 0 10px;" onclick=""/><!-- 정선군 로고 이미지 -->
				</div>
				<div id="gw_controler">
					<div id="gw_top_btn">
						<ul>
							<li style="margin-left: 25px;"><img src="./img/btn_top/1_normal.png" class="work_btn" onclick="_CS.init.setSearchLinkType('ADDR'); _CS.init.srchjibunLoding(); gwsUtils.setWorkImgChange('1');" title="주소검색"/></li>
							<li><img src="./img/btn_top/2_normal.png" class="work_btn" onclick="_CS.init.setSearchLinkType('ADDR'); _CS.init.srchRoadAddrLoding(); gwsUtils.setWorkImgChange('2');" title="도로명검색"/></li>
							...
							<li><img src="./img/btn_top/9_normal.png" class="work_btn" auth="FW004" onclick="_CS.init.setSearchLinkType('KLIS'); _CS.init.srchjibunLoding(2); gwsUtils.setWorkImgChange('9');" title="토지대장"/></li>
							<li><img src="./img/btn_top/10_normal.png" class="work_btn" auth="FW005" onclick="_CS.init.setSearchLinkType('EAIS'); _CS.init.srchjibunLoding(2); gwsUtils.setWorkImgChange('10');" title="건축물대장"/></li>
							<li><img src="./img/btn_top/11_normal.png" class="work_btn" auth="FW006,FW007,FW008" onclick="_CS.init.setSearchLinkType('LURIS'); _CS.init.srchjibunLoding(2); gwsUtils.setWorkImgChange('11');" title="토지이용규제"/></li>
							<li><img src="./img/btn_top/12_normal.png" class="work_btn" onclick="_MAINMAP.toggleMapCtrlVisible();" title="관리도구"/></li>
