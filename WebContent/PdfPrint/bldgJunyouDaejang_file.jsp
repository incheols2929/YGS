...
<%@page import="geomex.utils.pdf.BldgJunyouExportURLPDF"%>
...
<%
	...
	BldgJunyouExportURLPDF EP = new BldgJunyouExportURLPDF();
	String filneme = EP.CreateURLPDF(key, pnu, ouln_pk, user_name);
